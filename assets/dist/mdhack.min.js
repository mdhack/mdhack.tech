...
var overRideTime="",overRideAnnoucement="Hope you had a great winter break! Your projects are due at the next meeting. Bring something that you are proud of!";window.onload=function(){document.getElementById("meeting-date").innerHTML=""==overRideTime?getNextDayOfWeek(new Date,3):overRideTime,""!==overRideAnnoucement&&(document.getElementById("announced").innerHTML=overRideAnnoucement)};function getNextDayOfWeek(e,t){var n=new Date(e.getTime());return n.setDate(e.getDate()+(7+t-e.getDay())%7),n.toDateString()}!function(e,t,n){var o,r=e.getElementsByTagName("script")[0];e.getElementById("facebook-jssdk")||((o=e.createElement("script")).id="facebook-jssdk",o.src="//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.10&appId=535422936849147",r.parentNode.insertBefore(o,r))}(document);